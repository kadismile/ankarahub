(function ($) {
    ...
    TC_Instance.prototype.initialize = function (clear_listeners) {
        ...
        if ($(window).width() < 767) {
            var spt_timer_dimension = 0.5;
        } else if ($(window).width() < 992) {
            var spt_timer_dimension = 0.4;
        } else {
            var spt_timer_dimension = 0.5;
        }
        this.data.attributes.item_size = Math.min(width / this.data.drawn_units.length, height);
        this.data.attributes.line_width = this.data.attributes.item_size * this.config.fg_width;
        this.data.attributes.radius = ((this.data.attributes.item_size * spt_timer_dimension) - this.data.attributes.line_width) / 2;
        ...
        for (var key in this.data.text_elements) {
            ...
            if ($(window).width() < 992) {
                headerElement.css("font-size", 16);
            } else {
                headerElement.css("font-size", 20);
            }
            ...
            if ($(window).width() < 992) {
                numberElement.css("font-size", 18);
            } else {
